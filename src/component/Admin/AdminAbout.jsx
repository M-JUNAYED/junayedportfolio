        ...
        <div className='text-[25px] text-white bg-gray-700 rounded'>
            ...
            <div className="grid grid-cols-2 justify-center p-3">
                <div className="">
                    ...
                    <div className="">
                        {['title', 'short_des', 'about_img','skills'].map((field, index) => (
                        ...
                        {data && data.length > 0 ? (
                            data.map((item, index) => (
                                <div key={index} className='text-[25px]'>
                                    ...
                                    <div>
                                        <p className="text-3x underline my-5">About Page Image</p>
                                        <div className="flex justify-center">
                                            <Image src={item.about_img} width={500} height={500} alt="home image" className="w-1/2 h-auto rounded" />
                                        </div>
                                        <div className="flex justify-center">
                                            <p>{item.skills}</p>
                                        </div>
